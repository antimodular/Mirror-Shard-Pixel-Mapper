...
// Transform for texture sampling - FINAL CORRECT VERSION
// Receives inverseHomography and inverts it to map display -> source
vec2 transformForSampling(vec2 displayPoint, mat4 invH) {
    // Invert inverseHomography to get homography (display -> source mapping)
    mat4 H = mat4(1.0);
...
void main() {
    ...
    // Flip Y coordinate (WebGL Y=0 at bottom, calibration Y=0 at top)
