...
public:
    ...
    static void findHomography(T &src, T &dst, float homography[16]){
		...
		// ofLog() << "ofxHomography::findHomography() Homography matrix:";
		// for(int i=0;i<16;i++) {
		// 	ofLog() << aux_H[i];
		// }
	}
    ...
    static glm::mat4 findHomography(T &src, T &dst){
		...
		// // Log the full 4x4 matrix for debugging
		// ofLog() << "ofxHomography::findHomography() 4x4 matrix:";
		// for(int i=0;i<16;i++) {
		// 	ofLog() << i << ": " << homography[i];
		// }
